// oprator2.js
// 증감연산자 ++, -- 
let x = 5; // x변수 생성 -> 숫자5를 x에 대입
// let y = ++x; // y변수 생성 -> 1증가한 x를 대입
let y = x++; // y변수 생성 -> x를 대입하고 나중에 x를 1증가 
console.log(x,y);
let a;
let b;
let c;
let d;
//변수만 생성하고 값 정의안된 상태 (undefined)
a = 1;
b = 2;
c = 3;
d = 4;
...
let num3 = 30;
let num4 = 40;
num1++; //대입연산자가 없으면 증감연사자 앞뒤 의미없음
num2--;
num3++;
num4--;
// num1=11, num2=19, num3=31, num4=39 쉬운정답...
console.log(`num1=${num1},num2=${num2},num3=${num3},num4=${num4}`) 
num1 = ++num2; // +가 앞이면 증가 전 값 (전위) -> 20 20
num2 = num1++;  // (후위) -> 대입연산자(=):기존의값을지움 
...
console.log(`num1=${num1},num2=${num2},num3=${num3},num4=${num4}`) 
num1 = ++num3 + 10;  //대입연산자가들어가면 뒤에꺼부터 읽음 
num2 = --num4 + 1;
// num1=53, num2=42, num3=43, num4=41
console.log(`num1=${num1},num2=${num2},num3=${num3},num4=${num4}`) 
// ---------증감연산자 + 질문답변함수
// const는 변경 할 수 없음(상수) -> let으로 변경
// prompt 문자로 데이터 인식 -> Number()숫자 변환
// num++ 증가 전 값이 plus로 인식(+뒤에적으면 증가하기전 값이 대입값으로 넘어감) -> 전위연산변경(++num)
...
// 결과형태 : 편의점 총 구입비는 0000원이고 남은돈은 0000입니다.
my_wallet = 10000;
let rice = 2000;
let icecream = 3000;
let cookie = 4000;
my_total = rice + icecream + cookie;
my_wallet -= my_total;
let my_result =`편의점 총 구입비는 ${my_total.toLocaleString('ko-kr')}원이고 
남은돈은 ${my_wallet.toLocaleString('ko-kr')}입니다.`;
