...
for(let i of boxDd){
    console.log(i);
    i.style.borderBottom = '2px solid red'; //i자체를 객체로 인식
...
mLoginCart.appendChild(dLoginClone); //먼저붙여놓으면앞쪽(왼쪽)
mLoginCart.appendChild(dCartClone);

//모바일 메뉴 기준
//gnb 클릭 시 lnb보이기 (height 값 이용)
...
function mLnbHide(){ //메뉴가 안 겹치게 하나만 보이게
